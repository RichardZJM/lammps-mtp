...
action pair_mtps_kokkos.cpp pair_mtp.cpp
action pair_mtps_kokkos.h pair_mtp.h
action pair_mtps_extrapolation_kokkos.cpp pair_mtp_extrapolation.cpp
action pair_mtps_extrapolation_kokkos.h pair_mtp_extrapolation.h
