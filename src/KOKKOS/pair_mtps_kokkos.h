...
#ifdef PAIR_CLASS
// clang-format off
PairStyle(mtp/kk/s,PairMTPsKokkos<LMPDeviceType>);
PairStyle(mtp/kk/s/device,PairMTPsKokkos<LMPDeviceType>);
PairStyle(mtp/kk/s/host,PairMTPsKokkos<LMPHostType>);
// clang-format on
#else
